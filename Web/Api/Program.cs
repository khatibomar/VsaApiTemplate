...
using VsaApiTemplate.Users.Services;
using VsaApiTemplate.Web.Code;
...
static string BuildHangfireConnectionString(string connectionString)
{
	...
	builder.ApplicationName = builder.ApplicationName.Replace("VsaApiTemplate", "Hangfire", StringComparison.OrdinalIgnoreCase);
